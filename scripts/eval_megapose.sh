#!/usr/bin/env bash
# Standalone MegaPose render-and-compare (needs robot-detector detections; no checkpoint override)
# Usage: DATA_ROOT=/data scripts/eval_megapose.sh
#SBATCH --job-name=megapose
