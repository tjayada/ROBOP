#!/usr/bin/env bash
# GigaPose + MegaPose refiner (needs robot-detector detections)
# Usage: DATA_ROOT=/data scripts/eval_gigapose_megapose.sh
#SBATCH --job-name=gigapose_megapose
...
CHECKPOINT=${CHECKPOINT:-external/gigapose/pretrained/gigaPose_v1.ckpt}   # make download-gigapose
